...
/*
  ...
  ,"potato": {
    exec: function() {
      var data = {
         url: 'https://www.youtube.com/embed/C7fKoamz0nY?showinfo=0&amp;autoplay=1;modestbranding=1'
  ...
  ,"bandcamp": {
    exec: function() {
      var data = {
         url: "https://bandcamp.com/EmbeddedPlayer/album=2124128413/size=large/bgcol=ffffff/linkcol=0687f5/package=2677717965/transparent=true/"
        ,icon: '/c/sys/ico32/trophy.gif'
        ,title: 'Bandcamp'
        ,width: 350
        ,height: 853
