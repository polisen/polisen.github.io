...
<head>
  ...
  <link rel="shortcut icon" type="image/x-icon" href="/favicon.ico?v=2.2.3" />

  <link rel="stylesheet" href="/c/sys42.css?v=2.2.3">
  <link rel="stylesheet" href="/c/sys/skins/w93.css?v=2.2.3" id="w93_skin">
  <link rel="stylesheet" href="/sys/hotfix.css?v=2.2.3"></head>
  <body class="app_emulator">
    ...
    <script src="/c/sys42.js?v=2.2.3"></script>
...
//
      ...
      function go() {
        ...
        loadRom(loadRomData('/c/files/roms/sms/games/Shinobi.sms'));
